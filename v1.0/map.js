...
function ab()
{
    ...
    <area href="##" alt="Open Air Theatre" title="Open Air Theatre" onClick="cha('OAT')" coords="${l(716)},${b(731)},${l(802)},${b(856)}" shape="rect">
    ...
    <area href="##" alt="Indoor " title="Indoor " onClick="cha('indoor')" coords="${l(611)},${b(413)},${l(719)},${b(309)}" shape="rect">
    <area href="##" alt="Ground" title="Ground" onClick="cha('gr')" coords="${l(1013)},${b(109)},${l(924)},${b(199)},${l(926)},${b(319)},${l(929)},${b(460)},${l(1018)},${b(504)},${l(1099)},${b(474)},${l(1136)},${b(345)},${l(1131)},${b(190)},${l(1086)},${b(131)},${l(1052)},${b(111)}" shape="poly">
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-Y39QJDMJ28"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-Y39QJDMJ28');
</script>